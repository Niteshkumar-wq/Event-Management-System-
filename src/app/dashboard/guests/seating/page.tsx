        ...
        <div className="lg:col-span-1 glass-card p-4 space-y-4">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 bg-slate-800/50 border border-slate-700/50 rounded-md text-xs text-white placeholder:text-slate-600 focus:outline-none focus:border-violet-500/50"
            />
          </div>
          ...
          <div className="space-y-1.5 max-h-[450px] overflow-y-auto">
            {unassignedGuests.map(guest => (
              <div
                ...
                className="flex items-center gap-2 p-2.5 rounded-lg border border-slate-700/50 bg-slate-800/30 hover:bg-slate-800/60 cursor-grab active:cursor-grabbing transition-colors group"
              >
                ...
                {selectedTable && (
                  <button
                    ...
                    className="p-1 rounded hover:bg-violet-500/20 text-slate-500 hover:text-violet-400 transition-colors"
          ...
          {selectedTable && (
            <div className="p-3 rounded-lg bg-violet-500/10 border border-violet-500/20">
              ...
              <p className="text-[10px] text-violet-400/70 mt-0.5">Click a guest or drag to assign</p>
            </div>
          )}
        </div>
      </div>
